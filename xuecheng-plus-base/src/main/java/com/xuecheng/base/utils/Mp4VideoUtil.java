...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "/Cellar/ffmpeg/5.1.2/bin/ffmpeg";//ffmpeg的安装位置
    String video_path = "/Users/dujianzhang/Downloads/3a5a861d1c745d05166132c47b44f9e4.avi";
    String mp4_name = "test1.mp4";
    String mp4folder_path = "~/Movies/test1/";
    ...
    public static void main(String[] args) throws IOException {
        String ffmpeg_path = "/usr/local/bin/ffmpeg";//ffmpeg的安装位置
        String video_path = "/Users/dujianzhang/Downloads/3a5a861d1c745d05166132c47b44f9e4.avi";
        String mp4_name = "test1.mp4";
        String mp4folder_path = "/Users/dujianzhang/" + mp4_name;
        //创建工具类对象
